...
const SentMessage = () => {
  ...
  return (
    ...
    <div className='container mx-auto my-16 md:my-20'>
        <div className="grid gird-cols-1 lg:grid-cols-2 gap-8 py-16 px-4 items-center">
            <div>
                <Image src={'/message.jpg'} alt='sent message' width={735} height={890} className="w-full aspect-5/4 rounded-2xl"/>
            </div>
            <div>
                 <Form {...form}>
